...
from ..pre_processes import ToBatch, ToCHWImage, Normalize, Resize, ResizeByShort
from ...results.img_class import TopkResult
...
class ClasPredictor(BasePredictor):
    ...
    def __init__(self, topk=None, **kwargs) -> None:
    ...
    def _build(self) -> tuple:
        ...
        """
        preprocessors = {"Read": ReadImage(format_="RGB")}
    ...
    def process(self, batch_data, topk=None):
        """
    ...
    def build_resize(self, resize_short=None, size=None, backend="cv2", interpolation="LINEAR"):
